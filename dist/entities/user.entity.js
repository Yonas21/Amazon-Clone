...
let UserEntity = (() => {
    let _classDecorators = [Entity("user"), Unique(["username"])];
    ...
    (() => {
        ...
        _username_decorators = [Column(), IsString(), Length(4, 20)];
        _password_decorators = [Column(), IsString(), Length(4, 100)];
        _role_decorators = [Column(), IsNotEmpty()];
        _createdAt_decorators = [Column(), CreateDateColumn()];
        _updatedAt_decorators = [Column(), UpdateDateColumn()];
